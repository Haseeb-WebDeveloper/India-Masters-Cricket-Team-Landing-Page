...
interface MediaItemType {
    ...
    url: string;
    span: string;
    aspectRatio?: string; // Added aspectRatio property
}
        ...
        <>
            ...
            <motion.div
                ...
                className="fixed inset-0 w-full min-h-screen sm:h-[90vh] md:h-[600px] backdrop-blur-lg 
                          rounded-none sm:rounded-lg md:rounded-xl overflow-hidden z-[400]"
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <div className="mb-8 text-center">
                <motion.h1
                    className=" text-pretty text-[2.5rem] lg:text-[5rem] uppercase font-bold  bg-clip-text text-transparent 
                ...
                <motion.p
                    className="mt-2 text-sm sm:text-[1.5rem] text-muted-foreground"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
            ...
            <AnimatePresence mode="wait">
                {selectedItem ? (
                    ...
                    <motion.div
                        className="w-full grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-3 auto-rows-[90px]"
                        initial="hidden"
                        animate="visible"
                        exit="hidden"
                        variants={{
                    ...
                    >
                        {items.map((item, index) => (
                            <motion.div
                                ...
                                className={`relative overflow-hidden rounded-md cursor-pointer ${item.span}`}

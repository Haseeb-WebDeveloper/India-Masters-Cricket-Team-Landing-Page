...
const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    details:
      "Age: 43 DOB: 12 December 1981 Batting style: Left Handed Batsman Bowling Style: Slow Left arm Orthodox",
    description:
  ...
  },
  {
    ...
    details:
      "Age: 40 DOB: 27 OCTOBER 1984 Batting style: Left Handed Batsman Bowling: Left arm Medium fast",
    description:
  ...
  },
  {
    ...
    details:
      "Age: 39  DOB: 23 September 1985 Batting style: Right Handed Batsman",
    description:
  ...
  },
  {
    ...
    details:
      "Age: 42 DOB: 17 Nov 1982 Batting style: Right Handed batsman Bowling style: Right arm Offbreak",
    description:
  ...
  },
  {
    ...
    details:
      "Age: 40 DOB: 03 June 1984 Batting Style: Right Handed Batsman  Bowling style: Right Arm medium fast",
    description:
  ...
  },
  {
    ...
    details:
      "Age: 35 DOB: 12 August 1989 Bowling style: Slow Left arm Orthodox",
    description:
  ...
  },
  {
    ...
    details:
      "Age:41 DOB: 20 July 1983 Batting style: Right Handed batter/Wicketkeeper",
    description:
  ...
  },
  {
    ...
    details:
      "Age: 32 DOB: 06 January 1993 Bowling style: Slow Left arm Orthodox",
    description:
  ...
  },
  {
    ...
    details:
      "Age: 35 DOB: 25 OCTOBER 1989  Bowling Style: Right Arm medium fast",
    description:
        ...
        >
          {teamMembers.map((member, index) => (
            <motion.div
              key={member.id}
              className={cn(
                "relative h-[85vh] transition-all duration-700 ease-out border border-border rounded-xl",
